...
- **TypeScript**: Specifically here are react.js and next.js, which play the role of writing web pages and handling events.
...
- Next is to reduce the cost of building. Personal Github, along with Nginx and Let's Encrypt's SSL auto-renew mechanism to both increase security and save on SSL purchases.

## Outcome
-A personal portfolio page was born.
-Using Next.js is good for SEO and also suitable for future BE expansion.
-Using MDX (markdown + JSX) to write page content, increasing flexibility.
